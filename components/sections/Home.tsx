            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            <a
                                href="https://www.jasminec.space"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <Badge className="flex gap-3 instagram-gradient text-white px-4 py-2 text-2xl font-bold">
                                    <Sparkles className="w-4 h-4 mr-2" />
                                    <span>VISIT NEW PORTFOLIO</span>{" "}
                        ...
                        <motion.div variants={staggerItemVariants}>
                            <h1 className="text-4xl md:text-5xl font-bold instagram-gradient-text mb-6 leading-tight">
                                {" "}
                                Web Developer
                            </h1>
                        </motion.div>
                        ...
                        >
                            <motion.div variants={staggerItemVariants}>
                                <Button
                                    ...
                                    size="lg"
                                    onClick={() =>
                                        onSectionClick("portfolio", "projects")
                                    }
